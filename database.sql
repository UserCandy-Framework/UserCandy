...
INSERT INTO `uc_pages` (`id`, `url`, `pagefolder`, `pagefile`, `arguments`, `sitemap`, `stock`) VALUES
(1, 'Home', 'Home', 'Home', NULL, 'true', 'true'),
(2, 'Templates', 'Home', 'Templates', NULL, 'false', 'true'),
(3, 'assets', 'Home', 'assets', NULL, 'false', 'true'),
(4, 'Register', 'Auth', 'Register', NULL, 'false', 'true'),
(5, 'Activate', 'Auth', 'Activate', NULL, 'false', 'true'),
(6, 'Forgot-Password', 'Auth', 'Forgot-Password', NULL, 'false', 'true'),
(7, 'Reset-Password', 'Auth', 'Reset-Password', NULL, 'false', 'true'),
(8, 'Resend-Activation-Email', 'Auth', 'Resend-Activation-Email', NULL, 'false', 'true'),
(9, 'Login', 'Auth', 'Login', NULL, 'false', 'true'),
(10, 'Logout', 'Auth', 'Logout', NULL, 'false', 'true'),
(11, 'Change-Email', 'Members', 'Change-Email', NULL, 'false', 'true'),
(12, 'Change-Password', 'Members', 'Change-Password', NULL, 'false', 'true'),
(13, 'Edit-Profile', 'Members', 'Edit-Profile', NULL, 'false', 'true'),
(14, 'Edit-Profile-Images', 'Members', 'Edit-Profile-Images', NULL, 'false', 'true'),
(15, 'Privacy-Settings', 'Members', 'Privacy-Settings', NULL, 'false', 'true'),
(16, 'Account-Settings', 'Members', 'Account-Settings', NULL, 'false', 'true'),
(17, 'LiveCheckEmail', 'Members', 'LiveCheckEmail', NULL, 'false', 'true'),
(18, 'LiveCheckUserName', 'Members', 'LiveCheckUserName', NULL, 'false', 'true'),
(19, 'Members', 'Members', 'Members', NULL, 'true', 'true'),
(20, 'Online-Members', 'Members', 'Online-Members', NULL, 'true', 'true'),
(21, 'Profile', 'Members', 'Profile', NULL, 'false', 'true'),
(22, 'AdminPanel', 'AdminPanel', 'AdminPanel', NULL, 'false', 'true'),
(23, 'AdminPanel-Settings', 'AdminPanel', 'AdminPanel-Settings', NULL, 'false', 'true'),
(24, 'AdminPanel-AdvancedSettings', 'AdminPanel', 'AdminPanel-AdvancedSettings', NULL, 'false', 'true'),
(25, 'AdminPanel-EmailSettings', 'AdminPanel', 'AdminPanel-EmailSettings', NULL, 'false', 'true'),
(26, 'AdminPanel-Users', 'AdminPanel', 'AdminPanel-Users', NULL, 'false', 'true'),
(27, 'AdminPanel-User', 'AdminPanel', 'AdminPanel-User', NULL, 'false', 'true'),
(28, 'AdminPanel-Groups', 'AdminPanel', 'AdminPanel-Groups', NULL, 'false', 'true'),
(29, 'AdminPanel-Group', 'AdminPanel', 'AdminPanel-Group', NULL, 'false', 'true'),
(30, 'AdminPanel-MassEmail', 'AdminPanel', 'AdminPanel-MassEmail', NULL, 'false', 'true'),
(31, 'AdminPanel-AuthLogs', 'AdminPanel', 'AdminPanel-AuthLogs', NULL, 'false', 'true'),
(32, 'AdminPanel-SiteLinks', 'AdminPanel', 'AdminPanel-SiteLinks', NULL, 'false', 'true'),
(33, 'AdminPanel-SiteLink', 'AdminPanel', 'AdminPanel-SiteLink', NULL, 'false', 'true'),
(34, 'AdminPanel-Upgrade', 'AdminPanel', 'AdminPanel-Upgrade', NULL, 'false', 'true'),
(35, 'AdminPanel-PagesPermissions', 'AdminPanel', 'AdminPanel-PagesPermissions', NULL, 'false', 'true'),
(36, 'AdminPanel-PagePermissions', 'AdminPanel', 'AdminPanel-PagePermissions', NULL, 'false', 'true'),
(37, 'AdminPanel-TermsPrivacy', 'AdminPanel', 'AdminPanel-TermsPrivacy', NULL, 'false', 'true'),
(38, 'ChangeLang', 'Home', 'ChangeLang', NULL, 'false', 'true'),
(39, 'About', 'Home', 'About', NULL, 'true', 'true'),
(40, 'Contact', 'Home', 'Contact', NULL, 'true', 'true'),
(41, 'sitemap', 'Home', 'sitemap', NULL, 'false', 'true'),
(42, 'Terms', 'Home', 'Terms', NULL, 'false', 'true'),
(43, 'Privacy', 'Home', 'Privacy', NULL, 'false', 'true'),
(44, 'AdminPanel-Dispenser-Settings', 'AdminPanel', 'AdminPanel-Dispenser-Settings', NULL, 'false', 'true'),
(45, 'AdminPanel-Dispenser-Widgets', 'AdminPanel', 'AdminPanel-Dispenser-Widgets', NULL, 'false', 'true'),
(46, 'AdminPanel-Dispenser-Plugins', 'AdminPanel', 'AdminPanel-Dispenser-Plugins', NULL, 'false', 'true'),
(47, 'AdminPanel-Dispenser-Themes', 'AdminPanel', 'AdminPanel-Dispenser-Themes', NULL, 'false', 'true'),
(48, 'AdminPanel-Dispenser-Helpers', 'AdminPanel', 'AdminPanel-Dispenser-Helpers', NULL, 'false', 'true'),
(49, 'AdminPanel-Dispenser-Widgets-Settings', 'AdminPanel', 'AdminPanel-Dispenser-Widgets-Settings', NULL, 'false', 'true'),
(50, 'themes', 'Home', 'themes', NULL, 'false', 'true');
