...
$my_folder = str_replace("system", "", $my_folder);
...
if(folder_writable('system/Example-Config.php')){
...
<div class='card border-info mb-3'>
	<div class='card-header h4'>
		<h3>UserCandy Installation</h3>
	</div>
	<div class='card-body'>
		Welcome to the UserCandy Installation Process.  <br>
		First we are going to check and make sure you have everything needed to install. <br>
		<br>

		<div class="card mb-3">
		  <!-- Default panel contents -->
		  <div class="card-header h4">UserCandy requires the following to be installed and working before installation can continue.</div>
		  <!-- Table -->
		  <table class="table">
		...
		<div class="card mb-3">
			<!-- Default panel contents -->
			<div class="card-header h4">UserCandy requires the following files/folders to have write permission by server.</div>
			<!-- Table -->
			<table class="table">
		...
		<?php
			...
			if($error_count == "0"){
				...
				echo "<a href='$set_site_url?install_step=2' class='btn btn-primary btn-lg'>Move on to Step 2</a>";
			}else{
				echo "<div class='alert alert-danger'>There are <font color=red><b>$error_count errors</b></font> above. ";
				echo "<a href='$set_site_url' class='btn btn-warning btn-sm float-right'>Refresh Page</a><hr>";
